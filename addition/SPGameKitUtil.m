...
//    GKScore* score = [[[GKScore alloc] initWithCategory:@"sudok9_f"]autorelease];
...
+(void) sendScoreToGameCenter:(int)_score andId:(NSString *)str_id{
    GKScore* score = [[[GKScore alloc] initWithCategory:str_id]autorelease];
    // 위에서 kPoint 가 게임센터에서 설정한 Leaderboard ID
    score.value = _score;
